# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 17:16:58 2020
...
diretorio = r"D:\ProjectMultimidia\ProjectMultimidia\dataset"
categorias = ["with_mask", "without_mask"]
...
for categoria in categorias:
    path = os.path.join(diretorio, categoria)
...
headModel = Flatten(name="flateten")(headModel)
...
print("[INFO] Começando o treinamneto do modelo")
training = model.fit(
...
print("[INFO] Avaliando o treinamento")
...
print("[INFO] Salvando o modelo de detector de mascara")
...
plt.legend(loc = "Inferior esquerdo")
